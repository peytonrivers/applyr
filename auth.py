...
async def retrieve_information(code: str, db: Session = Depends(get_db)):
    ...
    try:
        ...
        response.set_cookie("access_token", access_token, httponly=True, samesite="none", secure=True, max_age=1200, domain=".apply-r.com")
        response.set_cookie("refresh_token", refresh_token, httponly=True, samesite="none", secure=True, max_age=604800, domain=".apply-r.com")
        return response
...
async def refresh_tokens(request: Request, db: Session = Depends(get_db)):
    ...
    response.set_cookie("access_token", new_access_token, httponly=True, samesite="none", secure=True, max_age=1200, domain=".apply-r.com")
    response.set_cookie("refresh_token", new_refresh_token, httponly=True, samesite="none", secure=True, max_age=604800, domain=".apply-r.com")
    return response